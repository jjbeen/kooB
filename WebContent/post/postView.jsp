...
<body>
	...
	<div class="ui container" id="list">
		<div class="ui huge breadcrumb">
			...
			<a class="active section"> 감상 </a> <i
				class="right chevron icon divider"></i> <a class="active section">
				${post.title} </a>
		</div>
		...
		<div class="ui very padded segment">
			<table class="ui very basic celled table">
				<tr>
					<th>작성자</th>
					<td><input type="hidden" id="userid" name="userid" value="${post.id}">${post.id}</td>
					<th>작성일</th>
					<td><fmt:formatDate value="${post.writedate}" /></td>
				</tr>
				<tr>
					<th>제목</th>
					<td>${post.title}</td>
				...
				<tr>
					<th>내용</th>
					<td colspan="3"><pre>${post.content}</pre></td>
				</tr>
				<!-- <thead>
					<tr>
						<th width="70%">작성자</th>
				...
				<tbody>
					<tr>
						<td data-label="Name">${post.id}</td>
						<td class="right aligned" data-label="Date"><fmt:formatDate
								value="${post.writedate}" /></td>
					</tr>
				</tbody>
				<thead>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td class="right aligned" data-label="Readcount">${post.readcount}</td>
					</tr>
				</tbody>
				<thead>
					<tr>
			...
			<div class="ui buttons" align="center">
				<button class="ui button" id="updateBtn" onclick="location.href='PostServlet?command=post_update_form&num=${post.num}'">수정</button>
				<button class="ui button" onclick="location.href='PostServlet?command=post_list'">목록</button>
				<button class="ui button" id="deleteBtn" onclick="location.href='PostServlet?command=post_delete&num=${post.num}'">삭제</button>
			</div>
		</div>
	</div>
